...
12. After introduction, add a section with title Dependencies and list installation instructions (Where, What, How) associated with platform type, related to SDKs/JS Libraries required for the events.dd guidelines/code snippets to remove any provisions related to autocapture of data
